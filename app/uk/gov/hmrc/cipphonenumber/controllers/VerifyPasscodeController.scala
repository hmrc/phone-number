...
@Singleton()
class VerifyPasscodeController @Inject() (cc: ControllerComponents, verifyConnector: VerifyConnector)(implicit
  ...
  private def callVerificationService(body: JsValue)(implicit hc: HeaderCarrier): Future[Result] =
    verifyConnector.verifyPasscode(body).transformWith {
