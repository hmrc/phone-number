...
@Singleton
class PhoneValidateConnector @Inject()(httpClientV2: HttpClientV2, config: AppConfig) extends Logging {

  def callService(implicit ec: ExecutionContext, request: Request[JsValue], hc: HeaderCarrier) = {
